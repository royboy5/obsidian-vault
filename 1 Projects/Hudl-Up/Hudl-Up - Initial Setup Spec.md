...
* **API Surface Domain:** `apps/Initial Setup-api`
* **Local Subdomain Router:** `https://Initial Setup.hudl-up.local/api/`
* **Database Container Target:** `postgres-Initial Setup`
...
- [ ] Initialize endpoint endpoints inside `apps/Initial Setup-api`
